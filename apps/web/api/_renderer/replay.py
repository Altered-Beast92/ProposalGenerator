...
def _find_spec_dir() -> Path:
    """
    Locates the shared spec.

    This module runs from two places: the repo, where the spec sits at
    packages/spec, and a deployed serverless bundle, where a copy is placed
    alongside it. Checking the local copy first means the bundle never depends
